...
tel="79606745415" # Номер телефона, на который будет посылаться СМС
sity = "34009" #Курск, другие коды могут быть найдены на http://weather.yandex.ru/static/cities.xml (id)
...
geturl = "http://sms.ru/sms/send?api_id=ae46f960-802e-3dc4-e5d9-77d727a0dceb&to="+tel+"&text="+sms #GET запрос
